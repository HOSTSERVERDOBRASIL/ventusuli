...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050b16] text-white">
      ...
      <div className="relative z-10 min-h-screen lg:grid lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="relative z-10 w-full max-w-[34rem]">
            <div className="mb-6 flex items-center justify-between lg:hidden">
              <Link href="/login" className="flex items-center gap-3">
                <Image src="/auth/ventu-suli-logo.png" alt="Logo Ventu Suli" width={56} height={56} />
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#ffd27a]">
                    Ventu Suli
                  </p>
                  <p className="text-sm text-slate-300">Evolucao, performance e comunidade</p>
                </div>
              </Link>
            </div>
            ...
            <div className="rounded-[2rem] border border-white/14 bg-[linear-gradient(180deg,rgba(9,18,34,0.96),rgba(6,12,25,0.92))] p-6 shadow-[0_30px_100px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:p-8 lg:p-10">
              <div className="mb-8">
                ...
                <p className="mt-3 max-w-lg text-base leading-7 text-slate-300">{description}</p>
              </div>
              {children}
            </div>
          </div>
